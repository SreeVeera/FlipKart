...
function XiaomiG() {
    ...
    const product = {
        id: 2,
        name: "XIAOMI G Series 80 cm (32 inch) QLED HD Ready Smart Google TV 2025 Edition with Dolby Audio| Wide Colour Gamut |Bezel-less Design | Google Assistant  (L32MB-APIN)",
        price: 13999,
